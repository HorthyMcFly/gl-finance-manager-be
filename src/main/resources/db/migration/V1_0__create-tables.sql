...
(
    ...
    INVESTMENT_BALANCE NUMERIC(20, 2) NOT NULL
);
...
(
    ID                INT AUTO_INCREMENT,
    CONSTRAINT        EXPENSE_CATEGORY_LIMIT_PK PRIMARY KEY (ID),
    FM_USER           INT NOT NULL,
    CONSTRAINT        EXPENSE_CATEGORY_LIMIT_FM_USER_FK FOREIGN KEY (FM_USER) REFERENCES FM_USER(ID),
    EXPENSE_CATEGORY  INT NOT NULL,
    CONSTRAINT        EXPENSE_CATEGORY_LIMIT_EXPENSE_CATEGORY_FK FOREIGN KEY (EXPENSE_CATEGORY) REFERENCES EXPENSE_CATEGORY(ID),
    EXPENSE_LIMIT     NUMERIC(20, 2) NOT NULL
);
